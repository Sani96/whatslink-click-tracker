...
Track WhatsApp link clicks across your WordPress site. Measure user intent, analyze campaigns, and unlock powerful insights.
...
* Detects clicks on all WhatsApp links
* Works on pages, posts, and WooCommerce products
* AJAX dashboard with pagination and search
...
= Does it track all WhatsApp links? =
Yes! It works with both `https://wa.me/` and `https://api.whatsapp.com/send` links.
...
Not at all. The plugin is optimized for performance and loads asynchronously.
